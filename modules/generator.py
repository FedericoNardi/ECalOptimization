...
class Shower:
    def __init__(self, energy, *args, **kwargs):
        ...
        self._pars_a = tf.convert_to_tensor(np.loadtxt('modules/pars/fit_pars_final_0.txt'), dtype=tf.float32)
        self._pars_b = tf.convert_to_tensor(np.loadtxt('modules/pars/fit_pars_final_1.txt'), dtype=tf.float32)
        self._pars_c = tf.convert_to_tensor(np.loadtxt('modules/pars/fit_pars_final_2.txt'), dtype=tf.float32)
